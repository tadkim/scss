...
*/
	...
	function drawTheme_case1(d_nm) {
		...
		var ars_left = g_center.append("arms")
			.attr("class", "arms")
			.attr("d", "M90 350 L120, 350, 180,300, Q230,340 230,276");
...
//Mouth(입) =============================================================
		...
		var nose = g_center.append("rect")
			.attr("fill", "#CEAB69")
			.attr("width", function(d){ return scales.nose.w(d.Unconvincing); }).attr("height", 10)
			.attr("rx", 4).attr("ry", 4)
			.attr("class", "nose")
			.attr("transform", function(d){
